...
if (! is_plugin_active('slivery-extender/slivery-extender.php') ) {
	new \Kirki\Section(
		'breadcrumb_section',
		[
			'title'       => esc_html__( 'Breadcrumb Section', 'goldy-mex' ),
	...
	Kirki::add_field( 'goldy_mex_recommand_breadcrumb_activ_section', [
		'type'      => 'goldy-mex-gp-upsell-breadcrumb-active',
		'settings'  => 'goldy_mex_recommand_breadcrumb_activ_section',
		'text'  => $lablefore,
		'reg_url'  => $plugin_dir,
