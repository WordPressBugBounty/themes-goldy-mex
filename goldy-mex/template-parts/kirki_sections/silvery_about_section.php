...
if (! is_plugin_active('slivery-extender/slivery-extender.php') ) {
	...
	new \Kirki\Section(
		'about_section',
		[
			'title'       => esc_html__( 'About Section', 'goldy-mex' ),
	...
	Kirki::add_field( 'goldy_mex_recommand_about_activ_section', [
		'type'      => 'goldy-mex-gp-upsell-about-active',
		'settings'  => 'goldy_mex_recommand_about_activ_section',
		'text'  => $lablefore,
		'reg_url'  => $plugin_dir,
