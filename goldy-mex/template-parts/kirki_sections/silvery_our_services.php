...
if (! is_plugin_active('slivery-extender/slivery-extender.php') ) {
	new \Kirki\Section(
		...
		[
			'title'       => esc_html__( 'Our Services', 'goldy-mex' ),
	...
	Kirki::add_field( 'goldy_mex_recommand_our_services_activ_section', [
		'type'      => 'goldy-mex-gp-upsell-ourservices-active',
		'settings'  => 'goldy_mex_recommand_our_services_activ_section',
		'text'  => $lablefore,
		'reg_url'  => $plugin_dir,
